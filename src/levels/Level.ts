...
export const level01: LevelDefinition = {
  ...
  entities: [
    // Spacing tuned to the bounce arc: rises <= 45px, gaps <= 60px.
    {
      id: "platform-001",
      type: "static-platform",
      x: 0,
    ...
    { id: "ring-001", type: "ring", x: 180, y: 480, value: 10 },
    { id: "ring-002", type: "ring", x: 540, y: 445, value: 10 },
    { id: "ring-003", type: "ring", x: 750, y: 410, value: 10 },
    { id: "ring-004", type: "ring", x: 950, y: 365, value: 10 },
    { id: "ring-005", type: "ring", x: 1170, y: 385, value: 10 },
    { id: "ring-006", type: "ring", x: 1420, y: 415, value: 10 },
    { id: "ring-007", type: "ring", x: 1650, y: 370, value: 10 },
    { id: "spike-001", type: "spikes", x: 300, y: 504, width: 32, height: 16 },
    { id: "checkpoint-001", type: "checkpoint", x: 1100, y: 355, width: 20, height: 70 },
    { id: "exit-001", type: "level-exit", x: 1950, y: 375, width: 48, height: 90 },
  ],
};
